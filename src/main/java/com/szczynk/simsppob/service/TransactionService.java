...
public class TransactionService {
        ...
        public PaymentResponse payment(String email, String serviceCode) {
                ...
                com.szczynk.simsppob.model.Service service = serviceRepository.findById(serviceCode).orElse(null);

                if (balance.getBalanceAmount() < service.getServiceTariff()) {
                        throw new RuntimeException("Balance Kurang");
                }
        ...
        public List<TransactionResponse> getAllTransactions(
                ...
                int pageSize = limit.orElse(0).intValue();
                int pageNumber = page.orElse(0).intValue();
